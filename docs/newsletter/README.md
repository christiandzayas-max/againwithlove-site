...
1. **Value first, every single week.** The reader's time is precious. Earn it.
2. **Sound human.** Write like a real person (see `VOICE.md`). No em dashes, no
   en dashes, none of the tells that give away a machine wrote it.
3. **Source everything.** Every fact, figure, or research item is traceable to a
   named primary source, or it gets cut (see `SOURCING.md`). No made-up quotes,
   stats, or reader stories.
4. **No medical claims, ever.** We help caregivers cope, plan, and comfort. We do
